      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-sm">Create and edit email templates with advanced AI assistance for better engagement.</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Easy Automation</h4>
            <p className="text-gray-600 text-sm">Set up automated campaigns and personalized email sequences with ease.</p>
          </div>
        </div>
      </main>
    </div>
